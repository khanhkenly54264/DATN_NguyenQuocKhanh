...
namespace DichVuChuyenNha.Areas.admins.Controllers
{
    public class ThanhToansController : BaseController
    {
        ...
        public ThanhToansController(DichVuChuyenNhaContext context)
        {
            _context = context;
        }
        ...
        {
            var dichVuChuyenNhaContext = _context.ThanhToans.Include(t => t.MaDonHangNavigation);
        ...
        public async Task<IActionResult> Create([Bind("MaThanhToan,MaDonHang,SoTien,PhuongThuc,TrangThai,NgayThanhToan")] ThanhToan thanhToan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaThanhToan,MaDonHang,SoTien,PhuongThuc,TrangThai,NgayThanhToan")] ThanhToan thanhToan)
        {
